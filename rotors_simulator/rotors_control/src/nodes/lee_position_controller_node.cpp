...
LeePositionControllerNode::LeePositionControllerNode() {
  // ROS_INFO_ONCE("Started Lee Position Controller 00000000000000000000000");
  ...
  // ROS_INFO_ONCE("Started Lee 7777777777777777 Position Controller");
...
LeePositionControllerNode::~LeePositionControllerNode() {
ROS_INFO_ONCE("Started Lee Position Controller Destructor");
 }
...
void LeePositionControllerNode::MultiDofJointTrajectoryCallback(
  ...
  // ROS_INFO_ONCE("Reveiced command trajectory  !!!!!!!!!!!!!!!!!!!!!!");
  // Clear all pending commands.
  command_timer_.stop();
  commands_.clear();
  command_waiting_times_.clear();
...
void LeePositionControllerNode::OdometryCallback(const nav_msgs::OdometryConstPtr& odometry_msg) {
  ...
  // ROS_INFO("LeePositionController got  odometry message.");
  ...
  // ROS_DEBUG("Started Lee 6666666666666 Position Controller");
...
int main(int argc, char** argv) {
  ...
  // ROS_INFO_ONCE("Started Lee 2 Position Controller.");
